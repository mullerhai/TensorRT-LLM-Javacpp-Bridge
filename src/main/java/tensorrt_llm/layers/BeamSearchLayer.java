...
@Name("tensorrt_llm::layers::BeamSearchLayer<float>") @NoOffset @Properties(inherit = tensorrt_llm.presets.LayersConfig.class)
public class BeamSearchLayer extends BaseLayer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BeamSearchLayer(Pointer p) { super(p); }

    public BeamSearchLayer(@Const @ByRef Pointer mode, @Const @ByRef DecoderDomain decoderDomain,
