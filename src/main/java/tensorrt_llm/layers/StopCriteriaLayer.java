...
@Name("tensorrt_llm::layers::StopCriteriaLayer<float>") @NoOffset @Properties(inherit = tensorrt_llm.presets.LayersConfig.class)
public class StopCriteriaLayer extends BaseLayer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StopCriteriaLayer(Pointer p) { super(p); }

    public StopCriteriaLayer(@Const @ByRef Pointer mode, @Const @ByRef DecoderDomain arg1,
            @SharedPtr BufferManager bufferManager) { super((Pointer)null); allocate(mode, arg1, bufferManager); }
    private native void allocate(@Const @ByRef Pointer mode, @Const @ByRef DecoderDomain arg1,
