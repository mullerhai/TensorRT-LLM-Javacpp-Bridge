...
@Name("tensorrt_llm::layers::TopPSamplingLayer<float>") @NoOffset @Properties(inherit = tensorrt_llm.presets.LayersConfig.class)
public class TopPSamplingLayer extends BaseLayer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TopPSamplingLayer(Pointer p) { super(p); }

    public TopPSamplingLayer(@Const @ByRef DecoderDomain decoderDomain, @SharedPtr BufferManager bufferManager,
            boolean isDeterministic/*=true*/, boolean isAirTopP/*=true*/) { super((Pointer)null); allocate(decoderDomain, bufferManager, isDeterministic, isAirTopP); }
    private native void allocate(@Const @ByRef DecoderDomain decoderDomain, @SharedPtr BufferManager bufferManager,
            boolean isDeterministic/*=true*/, boolean isAirTopP/*=true*/);
    public TopPSamplingLayer(@Const @ByRef DecoderDomain decoderDomain, @SharedPtr BufferManager bufferManager) { super((Pointer)null); allocate(decoderDomain, bufferManager); }
    private native void allocate(@Const @ByRef DecoderDomain decoderDomain, @SharedPtr BufferManager bufferManager);
