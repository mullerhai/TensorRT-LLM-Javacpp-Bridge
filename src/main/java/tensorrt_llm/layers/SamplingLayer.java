...
@Name("tensorrt_llm::layers::SamplingLayer<float>") @NoOffset @Properties(inherit = tensorrt_llm.presets.LayersConfig.class)
public class SamplingLayer extends BaseLayer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SamplingLayer(Pointer p) { super(p); }


    public SamplingLayer(@Const @ByRef Pointer mode, @Const @ByRef DecoderDomain decoderDomain,
