...
public class McastGPUBuffer extends Pointer {
    ...
    public native @ByVal Tensor getUCBuffer(int rank, @StdVector CLongPointer sizes, @ByVal Pointer dtype, long storageOffset);
    ...
    public native @ByVal Tensor getMCBuffer(@StdVector CLongPointer sizes, @ByVal Pointer dtype, long storageOffset);
}
