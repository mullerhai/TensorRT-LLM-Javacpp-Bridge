...
public class lruPlugin extends BasePlugin {
    ...
    public lruPlugin(int dim, int block_size, @ByVal int type, boolean removePadding, boolean pagedState, boolean yEnabled,
    ...
    private native void allocate(int dim, int block_size, @ByVal int type, boolean removePadding, boolean pagedState, boolean yEnabled,
