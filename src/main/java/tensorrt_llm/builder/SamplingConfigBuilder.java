...
// ``tensorrt_llm::executor::SamplingConfig`` — the full setter/getter-bearing class
// generated by JavaCPP from ``tensorrt_llm/executor/types.h`` (``SamplingConfig.java``
// under package ``tensorrt_llm.executor``).  Note: do NOT use
// ``tensorrt_llm.batch_manager.SamplingConfig`` — that one wraps the unrelated
// ``tensorrt_llm::runtime::SamplingConfig`` and is intentionally @Opaque.
