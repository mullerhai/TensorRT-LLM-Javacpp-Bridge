...
public class AdditionalOutput extends Pointer {
    ...
    public AdditionalOutput(@StdString String name, @ByVal Tensor output) { super((Pointer)null); allocate(name, output); }
    private native void allocate(@StdString String name, @ByVal Tensor output);
