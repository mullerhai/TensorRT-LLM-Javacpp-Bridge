...
public class UnifiedBlockTree extends Pointer {
    ...
    //!
    //!
    // FIXED: public native @StdVector std::optional<tensorrt_llm::batch_manager::radix_block_tree::BlockPtr> lookupBlocksAtAllPositions(
    // FIXED: @Const @ByRef PrefixKey prefix, int windowSize);
