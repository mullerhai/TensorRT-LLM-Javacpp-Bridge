...
public class CacheTransferLayer extends Pointer {
    ...
    private native void allocate(@ByVal CacheState cacheState, @UniquePtr BaseCacheFormatter kvFormatter);
    public CacheTransferLayer(@ByRef(true) CacheTransferLayer arg0) { super((Pointer)null); allocate(arg0); }
    @NoException(true) private native void allocate(@ByRef(true) CacheTransferLayer arg0);
