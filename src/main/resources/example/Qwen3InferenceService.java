...
public class Qwen3InferenceService implements AutoCloseable {
     ...
     */
    public Qwen3InferenceService(String engineDir, int maxBatchSize, int defaultMaxTokens) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建服务
        try (Qwen3InferenceService service = new Qwen3InferenceService(engineDir, 64, 512)) {
