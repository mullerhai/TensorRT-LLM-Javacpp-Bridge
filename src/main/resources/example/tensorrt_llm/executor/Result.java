...
public class Result extends Pointer {
    ...
    public native @Optional std::vector<tensorrt_llm::executor::VecLogProbs> logProbs(); public native Result logProbs(std::vector<tensorrt_llm::executor::VecLogProbs> setter);
