...
public class ParallelConfig extends Pointer {
    ...
    public ParallelConfig(CommunicationType commType/*=tensorrt_llm::executor::CommunicationType::kMPI*/,
            ...
            @StdVector @Optional PointerPointer deviceIds/*=std::nullopt*/,
            @StdVector @Optional PointerPointer participantIds/*=std::nullopt*/,
            @Optional OrchestratorConfig orchestratorConfig/*=std::nullopt*/,
            @Optional IntPointer numNodes/*=std::nullopt*/) { super((Pointer)null); allocate(commType, commMode, deviceIds, participantIds, orchestratorConfig, numNodes); }
    private native void allocate(CommunicationType commType/*=tensorrt_llm::executor::CommunicationType::kMPI*/,
            CommunicationMode commMode/*=tensorrt_llm::executor::CommunicationMode::kLEADER*/,
            @StdVector @Optional PointerPointer deviceIds/*=std::nullopt*/,
            @StdVector @Optional PointerPointer participantIds/*=std::nullopt*/,
            @Optional OrchestratorConfig orchestratorConfig/*=std::nullopt*/,
            @Optional IntPointer numNodes/*=std::nullopt*/);
