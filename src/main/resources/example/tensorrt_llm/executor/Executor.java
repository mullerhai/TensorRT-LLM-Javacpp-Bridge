...
public class Executor extends Pointer {
    ...
    public native @StdVector std::vector<tensorrt_llm::executor::Response> awaitResponses(
            @StdVector LongPointer requestIds);

    /** \brief Get the number of ready responses
     *  @param requestId An optional request id
     *  @return The number of ready responses */
    public native int getNumResponsesReady(@Optional LongPointer requestId/*=std::nullopt*/);
