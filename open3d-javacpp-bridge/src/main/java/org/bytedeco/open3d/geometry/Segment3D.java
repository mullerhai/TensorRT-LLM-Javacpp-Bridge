...
/** \class Segment3D
 * 
 *  \brief A segment is a semantic interpretation of Pointer
...
public class Segment3D extends Line3D {
    ...
    /** \brief Takes a Pointer of points, the first to be used as the start
     *  point/origin and the second to be the end point */
    public Segment3D(@Const @ByRef Pointer pair) { super((Pointer)null); allocate(pair); }
    private native void allocate(@Const @ByRef Pointer pair);
