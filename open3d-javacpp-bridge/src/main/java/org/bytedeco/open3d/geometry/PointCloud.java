...
public class PointCloud extends Geometry3D {
    ...
    ///
    ///
    public native @ByVal Pointer VoxelDownSampleAndTrace(double voxel_size,
    ...
    ///
    public native @ByVal Pointer RemoveRadiusOutliers(long nb_points,
    ...
    ///
    ///
    public native @ByVal Pointer RemoveStatisticalOutliers(long nb_neighbors,
                                  double std_ratio,
                                  @Cast("bool") boolean print_progress/*=false*/);
    public native @ByVal Pointer RemoveStatisticalOutliers(long nb_neighbors,
                                  double std_ratio);
    ...
    public native void EstimateNormals(
                @Const @ByRef(nullValue = "Pointer()") KDTreeSearchParam search_param,
    ...
    public native void OrientNormalsToAlignWithDirection(
                @Const @ByRef(nullValue = "Pointer(0.0, 0.0, 1.0)") Vector3d orientation_reference);
    public native void OrientNormalsToAlignWithDirection();
    ...
    public native void OrientNormalsTowardsCameraLocation(
                @Const @ByRef(nullValue = "Pointer()") Vector3d camera_location);
    public native void OrientNormalsTowardsCameraLocation();
    ...
    ///
    public native @ByVal Pointer ComputeMeanAndCovariance();
    ...
    ///
    ///
    public native @ByVal Pointer ComputeConvexHull(@Cast("bool") boolean joggle_inputs/*=false*/);
    public native @ByVal Pointer ComputeConvexHull();
    ...
    ///
    ///
    public native @ByVal Pointer HiddenPointRemoval(@Const @ByRef Vector3d camera_location,
                           double radius);
    ...
    ///
    public native @ByVal Pointer SegmentPlane(
    ...
    ///
    ///
    public native Pointer DetectPlanarPatches(
                ...
                @Const @ByRef(nullValue = "Pointer(geometry::KDTreeSearchParamKNN())") KDTreeSearchParam search_param);
    public native Pointer DetectPlanarPatches();
    ...
    public static native @SharedPtr PointCloud CreateFromDepthImage(
                ...
                @Const @ByRef(nullValue = "Pointer()") Matrix4d extrinsic,
