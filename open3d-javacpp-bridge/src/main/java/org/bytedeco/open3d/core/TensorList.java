 ...
 *  Pointer. Internally, a tensorlist stores the Tensors in one
...
public class TensorList extends Pointer {
    ...
    public TensorList(@Const @ByRef SizeVector element_shape,
                   @ByVal Dtype dtype,
                   @Const @ByRef(nullValue = "Pointer(\"CPU:0\")") Device device) { super((Pointer)null); allocate(element_shape, dtype, device); }
    ...
    public TensorList(@Cast("int64_t") long size,
                   ...
                   @ByVal Dtype dtype,
                   @Const @ByRef(nullValue = "Pointer(\"CPU:0\")") Device device) { super((Pointer)null); allocate(size, element_shape, dtype, device); }
    ...
    ///
    public TensorList(@Const @ByRef Pointer tensors) { super((Pointer)null); allocate(tensors); }
    private native void allocate(@Const @ByRef Pointer tensors);
