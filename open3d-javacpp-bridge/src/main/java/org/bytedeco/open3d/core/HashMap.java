...
public class HashMap extends IsDevice {
    ...
    public HashMap(@Cast("int64_t") long init_capacity,
                ...
                @Cast("const Pointer") int backend/*=Pointer*/) { super((Pointer)null); allocate(init_capacity, key_dtype, key_element_shape, value_dtype, value_element_shapes, device, backend); }
     ...
     *  as in Insert. */
    public native @ByVal Pointer Activate(@Const @ByRef Tensor input_keys);
