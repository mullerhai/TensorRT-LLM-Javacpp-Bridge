...
public class Tensor extends IsDevice {
    ...
    public Tensor(@Const @ByRef SizeVector shape,
               @ByVal Dtype dtype,
               @Const @ByRef(nullValue = "open3d::core::Device(\"CPU:0\")") Device device) { super((Pointer)null); allocate(shape, dtype, device); }
    ...
    public Tensor(Pointer data_ptr,
               ...
               @Const @ByRef(nullValue = "open3d::core::SizeVector{}") SizeVector strides,
               @Const @ByRef(nullValue = "open3d::core::Device(\"CPU:0\")") Device device) { super((Pointer)null); allocate(data_ptr, dtype, shape, strides, device); }
    ...
    public static native @ByVal Tensor Arange(@Const @ByVal Scalar start,
                             ...
                             @Const @ByVal(nullValue = "open3d::core::Scalar(1)") Scalar step,
                             @Const @ByVal(nullValue = "open3d::core::Dtype(open3d::core::Int64)") Dtype dtype,
                             @Const @ByRef(nullValue = "open3d::core::Device(core::Device(\"CPU:0\"))") Device device);
    public static native @ByVal Tensor Arange(@Const @ByVal Scalar start,
                             @Const @ByVal Scalar stop);
     ...
     *  boolean tensors. */
    public native @ByVal Tensor All(@Optional SizeVector dims/*=std::nullopt*/,
    ...
    ///
    ///
    public native @ByVal Tensor Any(@Optional SizeVector dims/*=std::nullopt*/,
                   @Cast("bool") boolean keepdim/*=false*/);
    ...
    ///
    public native @ByVal std::tuple<open3d::core::Tensor,open3d::core::Tensor,open3d::core::Tensor> LU(@Cast("const bool") boolean permute_l/*=false*/);
    public native @ByVal std::tuple<open3d::core::Tensor,open3d::core::Tensor,open3d::core::Tensor> LU();
    ...
    ///
    public native @ByVal std::tuple<open3d::core::Tensor,open3d::core::Tensor> LUIpiv();
    ...
    public native @ByVal std::tuple<open3d::core::Tensor,open3d::core::Tensor> Triul(int diagonal/*=0*/);
    public native @ByVal std::tuple<open3d::core::Tensor,open3d::core::Tensor> Triul();
    ...
    public native @ByVal std::tuple<open3d::core::Tensor,open3d::core::Tensor,open3d::core::Tensor> SVD();
    ...
    @NoOffset public static class Iterator extends Pointer {
      ...
      // Typically Tensor&, but a tensor slice
        ...
        public Iterator(@Cast("open3d::core::Tensor::Iterator::pointer") Tensor tensor, @Cast("int64_t") long index) { super((Pointer)null); allocate(tensor, index); }
        private native void allocate(@Cast("open3d::core::Tensor::Iterator::pointer") Tensor tensor, @Cast("int64_t") long index);
        ...
        public native @ByVal @Cast("open3d::core::Tensor::Iterator::reference*") @Name("operator *") Tensor multiply();
        public native @Cast("open3d::core::Tensor::Iterator::pointer") @Name("operator ->") Tensor access();
    ...
    @NoOffset public static class ConstIterator extends Pointer {
      ...
      // Typically Tensor&, but a tensor slice
        ...
        public ConstIterator(@Cast("open3d::core::Tensor::ConstIterator::pointer") Tensor tensor, @Cast("int64_t") long index) { super((Pointer)null); allocate(tensor, index); }
        private native void allocate(@Cast("open3d::core::Tensor::ConstIterator::pointer") Tensor tensor, @Cast("int64_t") long index);
        ...
        public native @ByVal @Cast("open3d::core::Tensor::ConstIterator::reference*") @Name("operator *") Tensor multiply();
        public native @Cast("open3d::core::Tensor::ConstIterator::pointer") @Name("operator ->") Tensor access();
