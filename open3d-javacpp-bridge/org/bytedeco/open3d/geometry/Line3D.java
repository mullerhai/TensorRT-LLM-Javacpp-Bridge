...
public class Line3D extends Pointer {
    ...
    /** enum class open3d::geometry::Line3D::LineType */
    ...
    public native @Cast("open3d::geometry::Line3D::LineType") int GetLineType();
    ...
    public native void Transform(@Const @ByRef Eigen::Transform<double,3,Eigen::Affine> t);

    /** \brief Returns a const reference to the underlying
     *  Eigen::ParametrizedLine object */
    public native @Const @ByRef Eigen::ParametrizedLine<double,3> Line();
    ...
    public native @ByVal std::pair<double,double> ClosestParameters(@Const @ByRef Line3D other);
    ...
    public native @ByVal std::pair<Eigen::Vector3d,Eigen::Vector3d> ClosestPoints(
