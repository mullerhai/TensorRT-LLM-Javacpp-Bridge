...
public class TriangleMesh extends MeshBase {
    ...
    ///
    public native @ByVal std::tuple<std::vector<int>,std::vector<size_t>,std::vector<double> > ClusterConnectedTriangles();
    ...
    public static native @ByVal std::tuple<std::shared_ptr<open3d::geometry::TriangleMesh>,std::vector<double> > CreateFromPointCloudPoisson(@Const @ByRef PointCloud pcd,
                                    long depth/*=8*/,
                                    float width/*=0.0f*/,
                                    float scale/*=1.1f*/,
    ...
    public static native @SharedPtr TriangleMesh CreateFromOrientedBoundingBox(
                ...
                @Const @ByRef(nullValue = "Eigen::Vector3d::Ones()") Vector3d scale,
    ...
    public static native @SharedPtr TriangleMesh CreateCoordinateFrame(
                double size/*=1.0*/,
                @Const @ByRef(nullValue = "Eigen::Vector3d(0.0, 0.0, 0.0)") Vector3d origin);
    public static native @SharedPtr TriangleMesh CreateCoordinateFrame();
    ...
    public native @StdVector std::pair<std::string,open3d::geometry::TriangleMesh::Material> materials_(); public native TriangleMesh materials_(std::pair<std::string,open3d::geometry::TriangleMesh::Material> setter);
